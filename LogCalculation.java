...
/**
* The LogCalculation program implements an application that calculates how many maple logs should be placed on a truck if you know the lengths of the logs.
*
...
public class LogCalculation {
  ...
  public static void main(String[] args) {
    ...
    if (logLength == 0.25||logLength == 0.5||logLength == 1) {
      ...
      System.out.println("The truck can carry " + logNumber + " logs that are " 
        + logLength + "m long.");
    } else {
